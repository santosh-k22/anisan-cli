...
// Icon identifies a named icon in the registry.
type Icon int

const (
	Lua      Icon = iota + 1 // Lua scraper indicator
	Go                       // Go built-in indicator
	Fail                     // Operation failure
	Success                  // Operation success
	Question                 // Prompt / question
	Mark                     // Highlight / bookmark
	Progress                 // In-progress activity
	Search                   // Search operation
	Link                     // URL / hyperlink
)

// icons maps each Icon to its multi-variant definition.
